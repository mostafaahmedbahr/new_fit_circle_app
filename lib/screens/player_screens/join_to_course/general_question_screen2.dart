...
class GeneralQuestionScreen2 extends StatefulWidget {
  const GeneralQuestionScreen2({Key? key}) : super(key: key);

  @override
  State<GeneralQuestionScreen2> createState() => _GeneralQuestionScreen2State();
}

class _GeneralQuestionScreen2State extends State<GeneralQuestionScreen2> {
  int activeStep = 0;
  @override
                  ...
                  Row(
                    children: [
                      NumberPicker(
                        ...
                        maxValue: 200,
                        onChanged: (value) {
                          cubit.changeCurrentValue(value);
                        },
                      ),
                      // SvgPicture.asset("");
                    ],
                  ),
                  Text('Current value: ${cubit.currentValue}'),
                  const Spacer(),
                  CustomButton(
